...
<body>
	...
	<form name="frm" method="post" class="frm" action="<%=request.getContextPath()%>/userJoinAction.do">
		...
		<input type="button" value="가입하기" class="btn" onclick="check()" style="width:64.5%; height:40px; margin-top:30px;"><br>
		<input type="submit" value="submit" class="btn" style="width:64.5%; height:40px; margin-top:30px;"><br>
